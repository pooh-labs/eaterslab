...
The database for this project is PostgreSQL. It supports every basic database interaction as well as concurrency.
...
The client app has little possibilities to post data on public API endpoint. Client app can mainly send reviews for specified cafeterias.
