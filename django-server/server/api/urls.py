...
urlpatterns = [
    ...
    path('cafeterias/<int:pk>/stats/hour', HourStatsView.as_view()),
    path('cafeterias/<int:pk>/stats/day', DayStatsView.as_view()),
    path('cafeterias/<int:pk>/stats/week', WeekStatsView.as_view()),
    path('cafeterias/<int:pk>/stats/month', MonthStatsView.as_view()),
    path('cafeterias/<int:pk>/stats/year', YearStatsView.as_view()),
