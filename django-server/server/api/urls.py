...
urlpatterns = [
    ...
    path('cafeterias/<int:cafeteria_pk>/stats/hour', HourStatsView.as_view()),
    path('cafeterias/<int:cafeteria_pk>/stats/day', DayStatsView.as_view()),
    path('cafeterias/<int:cafeteria_pk>/stats/week', WeekStatsView.as_view()),
    path('cafeterias/<int:cafeteria_pk>/stats/month', MonthStatsView.as_view()),
    path('cafeterias/<int:cafeteria_pk>/stats/year', YearStatsView.as_view()),
